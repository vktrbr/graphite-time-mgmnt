...
- **Критерии успеха итерации:**
    - **Точность предсказаний:** 1.2 (1) – //TODO: – определить конкретную метрику. Условно, качество
      предсказаний сроков выполнения задач лучше, чем ручное.
...
1. Точность предсказаний. TODO: Определить метрику точности с учетом асимметрии ошибок. Нам менее
   важно переоценить время выполнения задачи, чем недооценить.
...
- Метрики Критерии успеха:
    - Точность предсказаний: todo: кастомные метрики точности при условии асимметрии ошибок.
